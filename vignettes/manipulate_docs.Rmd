...
|------------------|--------------------|------------|-----------------------------------------------------------------|
| 문서 필터링      | filter             | rule_nm    | 개별 필터의 이름                                                |
|                  |                    | pattern    | 필터링을 위한 패턴 매치 정규표현식                              |
|                  |                    | accept     | allow/deny 여부, TRUE는 allow 패턴, FALSE는 deny 패턴           |
|                  |                    | use        | 개별 필터 사용여부, FALSE이면 미사용, TRUE인 건만 필터링에 사용 |
| 텍스트 대체      | replace            | rule_nm    | 개별 필터의 이름                                                |
|                  |                    | rule_class | 텍스트 대체 룰의 그룹 이름                                      |
|                  |                    | pattern    | 텍스트 대체를 위한 패턴 매치 정규표현식                         |
|                  |                    | replace    | 패턴에 매치된 텍스트를 대체할 텍스트 정의                       |
|                  |                    | use        | 개별 필터 사용여부, FALSE이면 미사용, TRUE인 건만 필터링에 사용 |
| 텍스트 연결      | concat             | rule_nm    | 개별 필터의 이름                                                |
|                  |                    | pattern    | 텍스트 연결을 위한 패턴 매치 정규표현식                         |
|                  |                    | replace    | 패턴에 매치된 텍스트를 대체할 텍스트 정의                       |
|                  |                    | use        | 개별 필터 사용여부, FALSE이면 미사용, TRUE인 건만 필터링에 사용 |
| 텍스트 분리      | split              | rule_nm    | 개별 필터의 이름                                                |
|                  |                    | pattern    | 텍스트 분리를 위한 패턴 매치 정규표현식                         |
|                  |                    | replace    | 패턴에 매치된 텍스트를 대체할 텍스트 정의                       |
|                  |                    | use        | 개별 필터 사용여부, FALSE이면 미사용, TRUE인 건만 필터링에 사용 |
| 텍스트 제거      | remove             | rule_nm    | 개별 필터의 이름                                                |
|                  |                    | pattern    | 텍스트 분제거를 위한 패턴 매치 정규표현식                       |
|                  |                    | use        | 개별 필터 사용여부, FALSE이면 미사용, TRUE인 건만 필터링에 사용 |

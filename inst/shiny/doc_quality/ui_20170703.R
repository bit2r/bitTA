...
shinyUI(
  navbarPage("TextWorld",
             ...
             tabPanel("검색/대체",
                      sidebarPanel(
                        selectInput("idname", "아이디 변수: ", choices=vnames, selected=vnames[1]),
                        ...
                        fluidRow(
                          column(width = 3,
                                 actionButton("up", "", icon = icon("toggle-left"))),
                          column(width = 6, textInput("cnt", NULL)),
                          column(width = 3,
                                 actionButton("down", "", icon = icon("toggle-right")))),
                        HTML("<b>패턴 변경:</b>"),
                        fluidRow(
             ...
             tabPanel("형태소분석",
                      sidebarPanel(
                        ...
                        fluidRow(
                          column(width = 3,
                                 actionButton("up2", "", icon = icon("toggle-left"))),
                          column(width = 6, textInput("cnt2", NULL)),
                          column(width = 3,
                                 actionButton("down2", "", icon = icon("toggle-right"))))
                      ),
             ...
             tabPanel("공동발생분석",
                      sidebarPanel(
                        ...
                        fluidRow(
                          column(width = 3,
                                 actionButton("up3", "", icon = icon("toggle-left"))),
                          column(width = 6, textInput("cnt3", NULL)),
                          column(width = 3,
                                 actionButton("down3", "", icon = icon("toggle-right"))))
                      ),
             ...
             tabPanel("N-Gram",
                      sidebarPanel(
                        ...
                        fluidRow(
                          column(width = 3,
                                 actionButton("up4", "", icon = icon("toggle-left"))),
                          column(width = 6, textInput("cnt4", NULL)),
                          column(width = 3,
                                 actionButton("down4", "", icon = icon("toggle-right"))))
                      ),
